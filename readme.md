...
## Real Promise Object (fetch example)

fetch is a web-api which is utilized to make api call and it returns a promise.

We will be calling public github api to fetch data [https://api.github.com/users/alok722](https://api.github.com/users/alok722)
